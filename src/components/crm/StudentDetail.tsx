...
export function StudentDetail({
  ...
  const crmDocumentTypes = [
    ...
    { id: 'topik_certificate', nameUz: "TOPIK sertifikati nusxasi", nameEn: "TOPIK certificate copy", nameRu: "Копия сертификата TOPIK", required: true },
    ...
    { id: 'diploma_apostille', nameUz: "Diplom / Attestat apostili", nameEn: "Diploma / certificate apostille", nameRu: "Апостиль диплома / аттестата", required: true },
  ...
  const crmTranslationSlots: Record<string, { id: string; nameUz: string; nameEn: string; nameRu: string; required: boolean }> = {
    ...
    topik_certificate: { id: 'topik_certificate_translation', nameUz: "TOPIK sertifikati tarjimasi", nameEn: "TOPIK certificate translation", nameRu: "Перевод сертификата TOPIK", required: false },
    ...
    diploma_apostille: { id: 'diploma_apostille_translation', nameUz: "Apostil tarjimasi", nameEn: "Apostille translation", nameRu: "Перевод апостиля", required: false },
          ...
          <Tabs defaultValue="profile" className="w-full">
            ...
            <div className="mt-3">
              <button
                ...
                className="flex items-center gap-2 w-full rounded-lg px-4 py-2.5 text-sm font-semibold transition-all shadow-sm border bg-gradient-to-r from-emerald-500/10 to-teal-500/10 text-emerald-700 dark:text-emerald-400 border-emerald-500/30 hover:from-emerald-500/20 hover:to-teal-500/20 hover:border-emerald-500/50"
              >
        ...
        <DialogContent className="!max-w-[95vw] !w-[95vw] !h-[90vh] flex flex-col" style={{ position: 'fixed', zIndex: 9999 }}>
          ...
          <div className="relative mt-2">
            ...
            <input
              ...
              className="w-full rounded-md border border-input bg-background px-9 py-2.5 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            />
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {filteredUniversities.map((uni) => {
                  ...
                  return (
                    ...
                    >
                      {uni.logo_url ? (
                        <img src={uni.logo_url} alt="" className="h-11 w-11 rounded-lg object-cover shrink-0" />
                      ) : (
